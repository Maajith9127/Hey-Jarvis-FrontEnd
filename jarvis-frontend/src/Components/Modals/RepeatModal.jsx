...
// 1️⃣ You will be given two arrays from the frontend: 
...
// 2️⃣ Your job is to generate a **series of Calendar Events** using the natural language prompt.

// 3️⃣ Every Calendar Event should follow one of these two formats:

// 📘 Todo Event Format:
// {
//   Type: 'Todo',
//   SpecificEventId: 'uuid',            ← You (Gemini) can generate this
//   title: 'Task Name',
...
// 📌 Example Set (Generated from input):
