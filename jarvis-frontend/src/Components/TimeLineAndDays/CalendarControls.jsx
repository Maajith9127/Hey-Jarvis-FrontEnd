...
//   const [deleteMode, setDeleteMode] = useState(false); // Add this line at the top with other useState hooks
  ...
  return (
    <div className="w-full mt-1 flex flex-wrap justify-center items-center gap-2 sticky top-0 z-50 bg-white">
      ...
      <button
        onClick={HandleSubmit}
        disabled={isSaving}
        className={`border text-xs px-3 py-1.5 font-medium shadow-sm transition whitespace-nowrap ${
          isSaving
            ? "bg-gray-200 text-gray-500 cursor-not-allowed"
            : "bg-white hover:bg-gray-100"
        }`}
      ...
      <button
        ...
        className={`border text-xs px-3 py-1.5 font-medium shadow-sm transition whitespace-nowrap rounded-md ${
          deleteMode ? 'bg-red-600 text-white hover:bg-red-700' : 'bg-gray-700 text-white hover:bg-gray-800'
        }`}
      >
