...
// import { useLoadPayouts } from '../../../hooks/usePayment.js';
...
//         dispatch(DeletePayoutFromRedux(id));
//     };

//     const handleChange = (id, key, value) => {
//         dispatch(UpdatePayoutFromRedux({ id, key, value }));
//     };
...
//         try {
//             const res = await savePayoutsDelta(payload); //  use real service
...
//                 {payouts.map((entry) => (
//                     <div key={entry.id} className="bg-white p-4 rounded shadow flex flex-col gap-3">
//                         <input
//                             type="text"
//                             placeholder="Name"
//                             value={entry.name}
...
//                             onChange={(e) => handleChange(entry.id, 'bankAccountId', e.target.value)}
//                             className="border px-3 py-2 rounded"
//                         >
